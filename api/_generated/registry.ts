...
export const REGISTRY: RegistrySnapshot = {
  "generatedAt": "2026-09-06T10:08:01.730Z",
  ...
  "components": [
    ...
    },
    {
      ...
      "inContext": {
        "description": "You rarely place this yourself — AgentImage and AgentCard both fall back to it when an agent has neither a registered image nor a name, which is the common case rather than the exception. Reach for it directly when you want the fingerprint unconditionally.",
