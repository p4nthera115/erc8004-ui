  ...
  return (
    <div className="flex flex-col gap-14">
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-mono text-3xl font-bold text-white">Theming</h1>
...
>
  ...
  --erc8004-card-fg: 0.145 0 0;   /* near-black text */
      ...
      <section className="flex flex-col gap-4">
        ...
        <ul className="flex flex-col gap-1 text-sm text-white/70 leading-relaxed pl-4 list-disc">
          <li>
            <strong className="text-white/90">Lightness</strong> ranges from{" "}
            <InlineCode>0</InlineCode> (black) to <InlineCode>1</InlineCode>{" "}
            (white).
          </li>
          <li>
            <strong className="text-white/90">Chroma</strong> controls
            saturation — <InlineCode>0</InlineCode> is gray, higher values are
            more vivid.
          </li>
          <li>
            <strong className="text-white/90">Hue</strong> is the color angle —{" "}
            <InlineCode>0</InlineCode> is pink/red, <InlineCode>145</InlineCode>{" "}
            is green, <InlineCode>260</InlineCode> is blue,{" "}
            <InlineCode>300</InlineCode> is purple.
          </li>
        </ul>
        <p className="text-sm text-white/60 leading-relaxed max-w-prose">
        ...
        {/* Surfaces table */}
        <p className="font-mono text-base text-white/90 mt-2">Surfaces</p>
        <TokenTable
          rows={[
            [
              "Background",
        ...
        {/* Accent table */}
        <p className="font-mono text-base text-white/90 mt-2">Accent</p>
        <TokenTable
          rows={[
            [
              "Accent",
        ...
        {/* Semantic table */}
        <p className="font-mono text-base text-white/90 mt-2">Semantic</p>
        <TokenTable
          rows={[
            [
              "Positive",
        ...
        {/* Borders & Focus table */}
        <p className="font-mono text-base text-white/90 mt-2">
          Borders &amp; Focus
        </p>
        <TokenTable
          rows={[
        ...
        {/* Chart Palette table */}
        <p className="font-mono text-base text-white/90 mt-2">Chart Palette</p>
        <TokenTable
          rows={[
            [
              "Chart 1",
        ...
        {/* Radius table */}
        <p className="font-mono text-base text-white/90 mt-2">Radius</p>
        <TokenTable
          rows={[
            [
              "Radius",
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="border border-white/10 divide-y divide-white/10 text-sm font-mono">
          <div className="grid grid-cols-3 px-4 py-2 text-white/40 text-xs uppercase tracking-wider">
            <span>Class</span>
            <span>Size</span>
            <span>Formula</span>
          </div>
          {[
            ...
            <div key={cls} className="grid grid-cols-3 px-4 py-2.5">
              <span className="text-white/90">{cls}</span>
...
function TokenTable({ rows }: { rows: [string, string, string, string][] }) {
  return (
    <div className="border border-white/10 divide-y divide-white/10 text-sm overflow-x-auto">
      <div className="grid grid-cols-4 px-4 py-2 text-white/40 text-xs uppercase tracking-wider font-mono">
        <span>Token</span>
      ...
      {rows.map(([token, cssVar, defaultVal, description]) => (
        <div key={cssVar} className="grid grid-cols-4 px-4 py-2.5 gap-x-4">
          ...
          <span className="font-mono text-white/60 text-xs">{cssVar}</span>
          <span className="font-mono text-white/50 text-xs">{defaultVal}</span>
