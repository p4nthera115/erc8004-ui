...
export function HeroSection() {
  ...
  return (
    <div className="h-[calc(100svh-80px)] border-b border-black/60 dark:border-white/25 grid grid-cols-2 font-mono overflow-x-hidden">
      ...
      <div className="col-span-1 diagonal-lines flex flex-col justify-between items-center overflow-hidden">
        <motion.div
          ...
          className="h-full px-20 pt-20 flex items-center justify-center transition-all duration-350 pb-55"
          style={{
            paddingBottom: codeBlockHeight
              ? `calc(5rem + ${codeBlockHeight}px)`
              : undefined,
          }}
        >
          <MockAgentCard
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ref={blockRef}
        layout
        className="bg-neutral-950 border-t border-black/60 dark:border-white/15 flex absolute w-1/2 right-0 bottom-0 overflow-hidden"
      >
