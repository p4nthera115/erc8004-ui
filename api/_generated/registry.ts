...
export const REGISTRY: RegistrySnapshot = {
  "generatedAt": "2026-09-05T05:24:23.055Z",
  ...
  "components": [
    ...
    },
    {
      ...
      "name": "AgentImage",
      "group": "Identity",
      "description": "Renders the agent's registered image. Supports IPFS, HTTPS, and base64 sources. When no image is registered it falls back to an initials avatar in a colour derived from the agent's identity — or to the deterministic FingerprintBadge when the agent has no name either.",
      "notes": [],
      ...
      "examples": [
        {
          "name": "Fallbacks",
          "description": "With no registered image, AgentImage renders the agent's initials on a colour derived from its registry and id — the same colour on every page and every reload. An agent with no registered name falls back to the deterministic FingerprintBadge instead.",
