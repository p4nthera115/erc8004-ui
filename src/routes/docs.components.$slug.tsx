  ...
  identity: (
    <div className="flex flex-col gap-10">
      <section className="flex flex-col gap-6">
        ...
        >
          <AgentName agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
        <ComponentPreview
          name="AgentImage"
          description="Agent's registered image (IPFS/HTTPS/base64). Falls back to FingerprintBadge."
        >
          <AgentImage agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
        <ComponentPreview
          name="AgentDescription"
          description="Agent's registered description text."
        >
          <AgentDescription agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
      </section>
      ...
      <section className="flex flex-col gap-6">
        ...
        >
          <AgentCard agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
        <ComponentPreview
          name="EndpointStatus"
          description="Lists all registered service endpoints (MCP, A2A, OASF, web, email) with protocol labels."
        >
          <EndpointStatus agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
      </section>
      ...
      <section className="flex flex-col gap-6">
        ...
        >
          <IdentityDisplay agentRegistry={REGISTRY} agentId={AGENT_ID} />
        </ComponentPreview>
      </section>
    </div>
  ),
