  ...
  return (
    <div className="flex flex-col gap-14">
      ...
      <section className="flex flex-col gap-4">
        ...
        {/*
          data-markdown-ignore: the markdown twin of this page (generated by
          scripts/generate-llms.ts) renders the same provisional-name notice
          using a canonical block-quote with slightly different wording. The
          AFDocs content-parity check would flag the HTML segments here as
          "missing" because they don't appear verbatim in the markdown — even
          though the same information is conveyed both places.
        */}
        <div
          data-markdown-ignore
          className="border border-black/60 dark:border-white/10 bg-neutral-50 dark:bg-white/2 px-5 py-4"
        >
