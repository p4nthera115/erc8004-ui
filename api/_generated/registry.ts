...
export const REGISTRY: RegistrySnapshot = {
  "generatedAt": "2026-09-05T02:08:56.892Z",
  ...
  "unpublishedNotice": "**NOTE — not yet on npm.** `@p4n/erc8004-ui` is the final package name, but it has not been published yet. Until it is, install directly from GitHub: https://github.com/p4nthera115/erc8004-ui.",
  ...
  "components": [
    ...
    },
    {
      ...
      "name": "AgentImage",
      "group": "Identity",
      "description": "Renders the agent's registered image. Supports IPFS, HTTPS, and base64 sources. Falls back to the deterministic FingerprintBadge when no image is registered.",
      "notes": [],
    ...
    },
    {
      ...
      "props": [
        ...
        },
        {
          ...
          "required": false,
          "default": "64",
          "description": "Rendered width and height in pixels. Also sets the FingerprintBadge fallback size."
        },
        {
          "name": "layout",
